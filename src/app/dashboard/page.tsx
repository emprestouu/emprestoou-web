    ...
    <div className="p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        <Card>
          ...
          <CardContent>
            <p className="text-2xl font-bold">R$ {data.totalEmprestado}</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-2xl font-bold">R$ {data.totalReceber}</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-2xl font-bold">R$ {data.dinheiroMovimentado}</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-2xl font-bold">{data.inadimplencia}%</p>
          </CardContent>
        </Card>
      </div>
