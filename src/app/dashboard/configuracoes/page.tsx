...
export default function Configuracoes() {
    ...
    return (
            ...
            <TabsList>
                ...
                <TabsContent value="perfil">
                    <form onSubmit={handleSubmit} className="space-y-4">
                        <h2 className="font-bold text-md">Configurar perfil</h2>
                        <Input
                            name="name"
                            type="text"
                            value={formData.name}
                ...
                <label className="text-sm font-medium text-gray-700">Mensagem Padrão do WhatsApp</label>
        <Textarea 
        ...
        <p className="text-xs text-gray-500">
          Use <b>{"{nome}"}</b> para o nome do cliente e <b>{"{valor}"}</b> para o valor da parcela.
        </p>
